---
title: 'MyBaseOptions 역할: Exchange 2013 Help'
TOCTitle: MyBaseOptions 역할
ms:assetid: 77b4643b-f777-44b8-87a4-040f9843515a
ms:mtpsurl: https://technet.microsoft.com/ko-kr/library/Dd876910(v=EXCHG.150)
ms:contentKeyID: 50483452
ms.date: 05/22/2018
...
개별 사용자는 `MyBaseOptions` 관리 역할을 사용하여 자신의 사서함 및 연결된 설정의 기본 구성을 보고 수정할 수 있습니다.
