---
title: '전송 에이전트 역할: Exchange 2013 Help'
TOCTitle: 전송 에이전트 역할
ms:assetid: 1679402e-158f-4630-8ef1-01ab5c7ce811
ms:mtpsurl: https://technet.microsoft.com/ko-kr/library/Dd876853(v=EXCHG.150)
ms:contentKeyID: 50482588
ms.date: 05/22/2018
...
`Transport Agents` 관리 역할을 통해 관리자가 조직의 전송 에이전트를 관리할 수 있습니다.
