---
title: '보기 전용 받는 사람에 게 역할: Exchange 2013 Help'
TOCTitle: 보기 전용 받는 사람에 게 역할
ms:assetid: 37e66b92-81d3-412f-b7a9-e1bb8cbeb468
ms:mtpsurl: https://technet.microsoft.com/ko-kr/library/Dd876872(v=EXCHG.150)
ms:contentKeyID: 50482859
ms.date: 05/22/2018
...
`View-Only Recipients` 관리 역할을 사용하면 관리자가 사서함, 메일 사용자, 메일 연락처, 메일 그룹, 동적 메일 그룹 등의 받는 사람 구성을 볼 수 있습니다.

`View-Only Configuration` 역할에 연결된 역할과 함께 이 역할을 사용하여 조직의 모든 개체를 볼 수 있는 역할 그룹을 만들 수 있습니다. 자세한 내용은 [보기 전용 구성 역할](view-only-configuration-role-exchange-2013-help.md)을 참조하십시오.
