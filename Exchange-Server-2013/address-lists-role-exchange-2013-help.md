---
title: '주소 목록 역할: Exchange 2013 Help'
TOCTitle: 주소 목록 역할
ms:assetid: 31143e30-16f5-45f5-b9a6-a39e6aa831d9
ms:mtpsurl: https://technet.microsoft.com/ko-kr/library/Dd876867(v=EXCHG.150)
ms:contentKeyID: 50482778
ms.date: 05/22/2018
...
`Address Lists` 관리 역할을 사용하면 관리자가 조직의 주소 목록, GAL(전체 주소 목록), 주소록 정책 및 OAB(오프라인 주소 목록)를 만들고 수정하고 보고 제거할 수 있습니다.
