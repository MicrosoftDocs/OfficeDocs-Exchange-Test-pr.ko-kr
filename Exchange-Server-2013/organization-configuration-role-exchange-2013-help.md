---
title: '조직 구성 역할: Exchange 2013 Help'
TOCTitle: 조직 구성 역할
ms:assetid: db952cc5-ef70-4366-acbb-0e292d4cbdd0
ms:mtpsurl: https://technet.microsoft.com/ko-kr/library/Dd876946(v=EXCHG.150)
ms:contentKeyID: 50484280
ms.date: 05/22/2018
...
`Organization Configuration` 관리 역할을 통해 관리자가 조직 차원의 설정을 관리할 수 있습니다. 이 역할을 사용하여 제어할 수 있는 조직 구성에는 다음이 포함됩니다.
  ...
  - 조직에 메일 설명을 사용할 것인지 여부

  - 관리되는 폴더 홈 페이지에 대한 URL

  - Microsoft Exchange 받는 사람 SMTP 주소 및 대체 전자 메일 주소

  - 리소스 사서함 속성 스키마 구성

  - Outlook Web App Exchange 관리 센터 및 Microsoft Office 대 한 도움말 Url

이 역할 유형에는 `Organization Client Access` 또는 `Organization Transport Settings` 역할에 포함된 사용 권한이 포함되지 않습니다.
