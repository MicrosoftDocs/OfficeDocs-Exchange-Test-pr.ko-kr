---
title: '저널링 역할: Exchange 2013 Help'
TOCTitle: 저널링 역할
ms:assetid: 64608dbe-d4b4-444e-a7df-bc536c4da202
ms:mtpsurl: https://technet.microsoft.com/ko-kr/library/Dd876894(v=EXCHG.150)
ms:contentKeyID: 50483279
ms.date: 05/22/2018
...
`Journaling` 관리 역할을 통해 관리자가 조직의 저널 규칙을 만들고 수정하고 사용하거나 사용하지 않도록 설정하고 보고 제거할 수 있습니다.
