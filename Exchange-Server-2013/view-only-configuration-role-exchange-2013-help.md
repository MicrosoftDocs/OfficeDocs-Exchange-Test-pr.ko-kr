---
title: '보기 전용 구성 역할: Exchange 2013 Help'
TOCTitle: 보기 전용 구성 역할
ms:assetid: 72607063-7f2d-4b3e-a2a9-27eb88e1e16a
ms:mtpsurl: https://technet.microsoft.com/ko-kr/library/Dd876907(v=EXCHG.150)
ms:contentKeyID: 50483356
ms.date: 05/22/2018
...
`View-Only Recipients` 역할과 관련된 역할에 이 역할을 조합하여 조직의 모든 개체를 볼 수 있는 역할 그룹을 만들 수 있습니다. 자세한 내용은 [보기 전용 받는 사람에 게 역할](view-only-recipients-role-exchange-2013-help.md)을 참조하십시오.
