...
> [!IMPORTANT]
> 자동 전화 교환에서 업무 시간을 구성해야 합니다. 업무 시간을 구성하면 업무 외 시간은 자동으로 설정됩니다. 자세한 내용은 <A href="https://docs.microsoft.com/ko-kr/exchange/voice-mail-unified-messaging/automatically-answer-and-route-calls/configure-business-hours">업무 시간을 구성 합니다.</A>을 참조하십시오.
