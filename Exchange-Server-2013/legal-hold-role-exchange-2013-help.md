---
title: '법적 보존 역할: Exchange 2013 Help'
TOCTitle: 법적 보존 역할
ms:assetid: c98ce8ca-3477-479a-ad23-a8e6459bc4d0
ms:mtpsurl: https://technet.microsoft.com/ko-kr/library/Dd876939(v=EXCHG.150)
ms:contentKeyID: 50484163
ms.date: 05/22/2018
...
`Legal Hold` 관리 역할을 통해 관리자가 조직에서 소송 대비를 목적으로 사서함 내의 데이터를 보관해야 하는지 여부를 구성할 수 있습니다.
...
받는 사람 범위 외에 이 역할에 포함된 <strong>Enable-Mailbox</strong> cmdlet의 범위도 데이터베이스 구성 범위를 사용하여 지정됩니다. 데이터베이스 구성 범위는 cmdlet이 새 사서함을 만들 수 있는 데이터베이스를 제어합니다. 사서함을 만들 데이터베이스가 데이터베이스 범위 내에 있어야 합니다. 이는 <strong>Enable-Mailbox</strong> cmdlet의 *Database* 매개 변수를 사용하여 데이터베이스를 지정하거나 자동 사서함 배포가 사용자에게 필요한 데이터베이스를 선택할 수 있도록 허용한 경우에 적용됩니다. 자세한 내용은 [관리 역할 범위 이해 (영문)](understanding-management-role-scopes-exchange-2013-help.md)를 참조하십시오.
