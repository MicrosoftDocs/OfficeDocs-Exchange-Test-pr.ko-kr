---
title: '감사 로그 역할: Exchange 2013 Help'
TOCTitle: 감사 로그 역할
ms:assetid: 36a7d375-76f8-441c-9da1-8a50dbd062f1
ms:mtpsurl: https://technet.microsoft.com/ko-kr/library/Dd876870(v=EXCHG.150)
ms:contentKeyID: 50482861
ms.date: 05/22/2018
...
`Audit Logs` 관리 역할을 사용하면 관리자가 조직의 관리자 감사 로그를 구성할 수 있습니다.
