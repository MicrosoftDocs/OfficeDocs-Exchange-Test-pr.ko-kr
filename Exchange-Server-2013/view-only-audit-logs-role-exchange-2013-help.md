---
title: '보기 전용 감사 로그 역할: Exchange 2013 Help'
TOCTitle: 보기 전용 감사 로그 역할
ms:assetid: 9298fe59-0a16-4a09-bdb8-514d1cea6e2f
ms:mtpsurl: https://technet.microsoft.com/ko-kr/library/Ff461933(v=EXCHG.150)
ms:contentKeyID: 50483680
ms.date: 05/22/2018
