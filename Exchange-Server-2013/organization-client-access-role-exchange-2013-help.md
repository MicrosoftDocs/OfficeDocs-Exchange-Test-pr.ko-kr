---
title: '조직의 클라이언트 액세스 역할: Exchange 2013 Help'
TOCTitle: 조직의 클라이언트 액세스 역할
ms:assetid: ff84799a-b79c-498d-b797-7675a4afb1eb
ms:mtpsurl: https://technet.microsoft.com/ko-kr/library/Dd876962(v=EXCHG.150)
ms:contentKeyID: 50484615
ms.date: 05/22/2018
...
`Organization Client Access` 관리 역할에는 관리자가 조직에서 클라이언트 액세스 서버 설정 관리를 수 있습니다.
