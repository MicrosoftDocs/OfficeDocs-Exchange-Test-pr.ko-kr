---
title: 'MyTeamMailboxes 역할: Exchange 2013 Help'
TOCTitle: MyTeamMailboxes 역할
ms:assetid: 269bf64a-5028-40e4-96ec-17c362a73e69
ms:mtpsurl: https://technet.microsoft.com/ko-kr/library/JJ673048(v=EXCHG.150)
ms:contentKeyID: 50482742
ms.date: 05/22/2018
...
`MyTeamMailboxes` 관리 역할을 사용하면 개별 사용자가 사이트 사서함을 만들고 이를 Microsoft SharePoint 사이트에 연결할 수 있습니다.
...
<tr class="odd">
<td><p>기본 역할 할당 정책</p>
<p>자세한 내용은 <a href="understanding-management-role-assignment-policies-exchange-2013-help.md">관리 역할 할당 정책 이해 (영문)</a> 항목을 참조하십시오.</p></td>
<td><p>X</p></td>
<td><p></p></td>
