---
title: '암호 역할을 다시 설정: Exchange 2013 Help'
TOCTitle: 암호 역할을 다시 설정
ms:assetid: d80101f1-7e3d-4a61-b93a-23da23e95e93
ms:mtpsurl: https://technet.microsoft.com/ko-kr/library/JJ657499(v=EXCHG.150)
ms:contentKeyID: 50484314
ms.date: 05/22/2018
...
암호 다시 설정 관리 역할에는 개별 사용자가 자신의 암호와 관리자가 조직에서 사용자의 암호를 원래 다시 설정할 수 있습니다.
