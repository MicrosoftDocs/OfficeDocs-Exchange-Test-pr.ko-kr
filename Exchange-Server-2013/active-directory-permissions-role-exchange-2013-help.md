---
title: 'Active Directory 권한 역할: Exchange 2013 Help'
TOCTitle: Active Directory 권한 역할
ms:assetid: 0908b4cb-08fd-44f6-bab6-c66af64b2d1a
ms:mtpsurl: https://technet.microsoft.com/ko-kr/library/Dd876845(v=EXCHG.150)
ms:contentKeyID: 50482464
ms.date: 05/22/2018
...
> [!NOTE]
> Active Directory 개체에 직접 설정된 사용 권한은 RBAC(역할 기반 액세스 제어)를 통해 적용하지 못할 수도 있습니다.
