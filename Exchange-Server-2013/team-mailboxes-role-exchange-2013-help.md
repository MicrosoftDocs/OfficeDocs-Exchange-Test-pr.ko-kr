---
title: '팀 사서함 역할: Exchange 2013 Help'
TOCTitle: 팀 사서함 역할
ms:assetid: b4591082-c4af-41bf-bbb1-ed2b931e62fb
ms:mtpsurl: https://technet.microsoft.com/ko-kr/library/JJ657485(v=EXCHG.150)
ms:contentKeyID: 50483891
ms.date: 05/22/2018
...
`Team Mailboxes` 관리 역할을 사용하면 관리자가 하나 이상의 사이트 사서함 프로비전 정책을 정의하고 조직의 사이트 사서함을 관리할 수 있습니다. 이 역할이 할당된 관리자는 자신이 소유하지 않은 사이트 사서함을 관리할 수 있습니다.
