---
title: '수신 커넥터 역할: Exchange 2013 Help'
TOCTitle: 수신 커넥터 역할
ms:assetid: a7c5a086-5066-4ece-9b22-cc1048d2f2bc
ms:mtpsurl: https://technet.microsoft.com/ko-kr/library/Dd876927(v=EXCHG.150)
ms:contentKeyID: 50483898
ms.date: 05/22/2018
...
`Receive Connectors` 관리 역할을 통해 관리자가 개별 서버에서 크기 제한 같은 전송 수신 커넥터 구성을 관리할 수 있습니다.
