---
title: '역할을 모니터링: Exchange 2013 Help'
TOCTitle: 역할을 모니터링
ms:assetid: ba4cb787-8e17-4565-bccd-74e846c06a4f
ms:mtpsurl: https://technet.microsoft.com/ko-kr/library/Dd876933(v=EXCHG.150)
ms:contentKeyID: 50484006
ms.date: 05/22/2018
...
모니터링 관리 역할을 통해 관리자가 조직의 Exchange 서비스와 구성 요소 가용성을 모니터링할 수 있습니다. 이 역할은 Exchange를 실행하는 서버의 상태 정보를 수집하는 모니터링 응용 프로그램에 의해 사용되는 서비스 계정에 사용할 수도 있습니다.
