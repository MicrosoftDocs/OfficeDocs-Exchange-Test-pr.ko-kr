---
title: '역할 관리 역할: Exchange 2013 Help'
TOCTitle: 역할 관리 역할
ms:assetid: 71d8553c-150d-4306-8de0-89be6efb5e40
ms:mtpsurl: https://technet.microsoft.com/ko-kr/library/Dd876906(v=EXCHG.150)
ms:contentKeyID: 50483353
ms.date: 05/22/2018
...
관리자는 `Role Management` 관리 역할을 사용하여 조직에서 관리 역할 그룹, 역할 할당 정책과 관리 역할, 그리고 역할 항목, 할당 및 범위를 관리할 수 있습니다.

이 역할이 할당된 사용자는 속성에 의해 관리되는 역할 그룹을 다시 정의하고, 역할 그룹을 구성하고, 역할 그룹에서 구성원을 추가하거나 제거할 수 있습니다.
