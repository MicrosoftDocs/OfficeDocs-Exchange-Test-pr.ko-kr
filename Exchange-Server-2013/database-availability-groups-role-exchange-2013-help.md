---
title: '데이터베이스 가용성 그룹 역할: Exchange 2013 Help'
TOCTitle: 데이터베이스 가용성 그룹 역할
ms:assetid: 0b3e0f7a-21e5-4209-8d5b-b63c6b9de3cc
ms:mtpsurl: https://technet.microsoft.com/ko-kr/library/Dd876847(v=EXCHG.150)
ms:contentKeyID: 50482477
ms.date: 05/22/2018
...
`Database Availability Groups` 관리 역할을 사용하면 관리자가 조직의 데이터베이스 가용성 그룹을 관리할 수 있습니다. 이 역할이 직접 또는 간접적으로 할당된 관리자는 조직의 고가용성 구성을 책임지는 최상위 수준 관리자입니다.
