---
title: 'MyTextMessaging 역할: Exchange 2013 Help'
TOCTitle: MyTextMessaging 역할
ms:assetid: 0e030bdb-8a72-4925-bb77-eaca249c36fc
ms:mtpsurl: https://technet.microsoft.com/ko-kr/library/Ee633454(v=EXCHG.150)
ms:contentKeyID: 50482463
ms.date: 05/22/2018
...
`MyTextMessaging` 관리 역할을 사용하면 개별 사용자가 텍스트 메시징 설정을 만들고, 보고, 수정할 수 있습니다.
