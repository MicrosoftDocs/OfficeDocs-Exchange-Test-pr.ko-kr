---
title: '메일 사용 가능 공용 폴더 역할: Exchange 2013 Help'
TOCTitle: 메일 사용 가능 공용 폴더 역할
ms:assetid: 22289ae1-f9e8-4c98-aaad-ee623e05eadd
ms:mtpsurl: https://technet.microsoft.com/ko-kr/library/Dd876859(v=EXCHG.150)
ms:contentKeyID: 50482726
ms.date: 05/22/2018
...
`Mail Enabled Public Folders` 관리 역할을 사용하면 관리자가 조직의 개별 공용 폴더에서 메일 사용이 가능한지 여부를 구성할 수 있습니다.

이 역할을 통해 공용 폴더의 전자 메일 속성만 관리할 수 있고 전자 메일과 관련이 없는 공용 폴더 속성은 관리할 수 없습니다. 전자 메일과 관련이 없는 공용 폴더 속성을 관리하려면 `Public Folders` 역할을 사용합니다. 자세한 내용은 [공용 폴더 역할](public-folders-role-exchange-2013-help.md) 항목을 참조하십시오.
