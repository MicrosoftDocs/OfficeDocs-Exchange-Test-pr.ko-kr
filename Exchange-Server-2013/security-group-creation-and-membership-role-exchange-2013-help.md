---
title: '보안 그룹 만들기 및 멤버 자격 역할: Exchange 2013 Help'
TOCTitle: 보안 그룹 만들기 및 멤버 자격 역할
ms:assetid: 257eb517-339f-4895-9e08-f772408a41cf
ms:mtpsurl: https://technet.microsoft.com/ko-kr/library/Dd876860(v=EXCHG.150)
ms:contentKeyID: 50482666
ms.date: 05/22/2018
mtps_version: v=EXCHG.150
ms.translationtype: MT
---

# 보안 그룹 만들기 및 멤버 자격 역할
...
`Security Group Creation and Membership` 관리 역할을 사용하면 관리자가 조직의 USG(유니버설 보안 그룹)와 해당 구성원을 만들고 관리할 수 있습니다.

Exchange가 실행되는 서버를 관리하는 그룹이 아닌 다른 그룹이 USG 만들기 및 관리를 수행하는 RBAC(역할 기반 액세스 제어) 분할 권한 모델을 유지 관리하는 조직의 경우 해당 그룹에 이 역할을 할당합니다.

Active Directory 분할 권한을 사용하도록 설정한 조직의 경우 이 관리 역할에 대해 위임되지 않은 모든 관리 역할 할당이 제거됩니다. Active Directory 사용 권한 분할을 사용하도록 설정하면 Active Directory 관리 도구를 사용하는 Active Directory 관리자만이 사용자 및 보안 그룹과 같은 새로운 보안 주체를 만들 수 있습니다.

자세한 내용은 [분할 권한 이해](understanding-split-permissions-exchange-2013-help.md) 항목을 참조하십시오.
