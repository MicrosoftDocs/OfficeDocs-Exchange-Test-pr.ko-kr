---
title: 'Exchange 커넥터 역할: Exchange 2013 Help'
TOCTitle: Exchange 커넥터 역할
ms:assetid: 73f98c82-bde0-443d-9bcf-274047e84e15
ms:mtpsurl: https://technet.microsoft.com/ko-kr/library/Dd876908(v=EXCHG.150)
ms:contentKeyID: 50483375
ms.date: 05/22/2018
...
관리자는 `Exchange Connectors` 관리 역할을 통해 배달 에이전트 커넥터를 만들고, 수정하고, 보고, 제거할 수 있습니다.

이 역할은 송신 및 수신 커넥터를 관리하는 데 사용할 수 없습니다. 송신 및 수신 커넥터를 관리하려면 Send Connectors 및 Receive Connectors 역할을 사용하십시오. 자세한 내용은 다음을 참조하십시오.
