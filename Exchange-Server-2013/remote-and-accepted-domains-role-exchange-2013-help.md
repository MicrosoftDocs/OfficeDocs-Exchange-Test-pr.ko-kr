---
title: '원격 및 허용 도메인 역할: Exchange 2013 Help'
TOCTitle: 원격 및 허용 도메인 역할
ms:assetid: 340c7546-5236-4743-a2b3-3c2363f3da1d
ms:mtpsurl: https://technet.microsoft.com/ko-kr/library/Dd876869(v=EXCHG.150)
ms:contentKeyID: 50482830
ms.date: 05/22/2018
...
`Remote and Accepted Domains` 관리 역할을 사용하면 관리자가 조직의 원격 도메인과 허용 도메인을 관리할 수 있습니다.
