---
title: 'MyDisplayName 역할: Exchange 2013 Help'
TOCTitle: MyDisplayName 역할
ms:assetid: d78d0032-29af-476b-82e3-69364ca7f12f
ms:mtpsurl: https://technet.microsoft.com/ko-kr/library/Ff461938(v=EXCHG.150)
ms:contentKeyID: 50484246
ms.date: 05/22/2018
...
`MyDisplayName` 관리 역할에는 개별 사용자를 보고 하 여 자신의 표시 이름을 수정할 수 있습니다. [MyProfileInformation 역할](myprofileinformation-role-exchange-2013-help.md) 상위 역할에서 만든 사용자 지정 역할입니다.
