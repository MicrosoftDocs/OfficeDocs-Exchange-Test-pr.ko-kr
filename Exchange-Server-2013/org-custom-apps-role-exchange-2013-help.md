---
title: '조직 사용자 지정 앱 역할: Exchange 2013 Help'
TOCTitle: 조직 사용자 지정 앱 역할
ms:assetid: ab2aac13-f783-43e6-a369-75cce1d4943f
ms:mtpsurl: https://technet.microsoft.com/ko-kr/library/JJ657482(v=EXCHG.150)
ms:contentKeyID: 50483843
ms.date: 05/22/2018
...
관리자는 Org Custom Apps 관리 역할을 사용하여 조직의 앱을 확인 및 수정하고 파일이나 URL에서 사용자 지정 앱을 추가할 수 있습니다.
