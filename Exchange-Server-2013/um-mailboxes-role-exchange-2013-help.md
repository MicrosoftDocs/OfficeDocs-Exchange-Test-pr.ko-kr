---
title: 'UM 사서함 역할: Exchange 2013 Help'
TOCTitle: UM 사서함 역할
ms:assetid: 6c9442dc-e674-4474-888e-e2f391a8eb57
ms:mtpsurl: https://technet.microsoft.com/ko-kr/library/Dd876901(v=EXCHG.150)
ms:contentKeyID: 50483392
ms.date: 05/22/2018
...
`UM Mailboxes` 관리 역할에는 관리자가 사서함 및 다른 받는 사람에 게 조직에서 통합 메시징 구성 관리를 수 있습니다.
