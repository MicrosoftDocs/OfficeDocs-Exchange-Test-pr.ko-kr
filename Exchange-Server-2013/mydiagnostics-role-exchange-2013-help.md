---
title: 'MyDiagnostics 역할: Exchange 2013 Help'
TOCTitle: MyDiagnostics 역할
ms:assetid: 62ba4bdd-6301-4daf-9368-3b393213ec1d
ms:mtpsurl: https://technet.microsoft.com/ko-kr/library/Dd979793(v=EXCHG.150)
ms:contentKeyID: 50483262
ms.date: 05/22/2018
...
`MyDiagnostics` 관리 역할을 사용하면 개별 사용자가 사서함에서 일정 진단 정보 검색과 같은 기본 진단을 수행할 수 있습니다.
