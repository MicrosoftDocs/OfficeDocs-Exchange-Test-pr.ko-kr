---
title: 'WorkloadManagement 역할: Exchange 2013 Help'
TOCTitle: WorkloadManagement 역할
ms:assetid: d5c90eae-95c3-44b0-add5-a97337d17743
ms:mtpsurl: https://technet.microsoft.com/ko-kr/library/JJ657498(v=EXCHG.150)
ms:contentKeyID: 50484291
ms.date: 05/22/2018
mtps_version: v=EXCHG.150
ms.translationtype: MT
---

# WorkloadManagement 역할
...
`WorkloadManagement` 관리 역할에는 관리자를 작업 관리 정책을 관리할 수 있습니다. 관리자는 리소스 상태 정의 작업 분류를 구성 하를 사용 하도록 설정 하거나 작업 관리를 사용 하지 않도록 설정할 수 있습니다. 변경 해야만 Microsoft 고객 서비스 및 지원의 지시에 따라 수행할 수 있습니다.
