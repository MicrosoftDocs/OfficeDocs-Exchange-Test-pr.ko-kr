---
title: 'MyDistributionGroups 역할: Exchange 2013 Help'
TOCTitle: MyDistributionGroups 역할
ms:assetid: 0d23dec0-3832-43bb-bc89-e01408acd0e8
ms:mtpsurl: https://technet.microsoft.com/ko-kr/library/Dd876849(v=EXCHG.150)
ms:contentKeyID: 50482456
ms.date: 05/22/2018
...
`MyDistributionGroups` 관리 역할을 사용하면 개별 사용자가 메일 그룹을 만들고 수정하고 볼 수 있으며 소유한 메일 그룹을 수정하고 보고 제거하고 구성원을 추가할 수 있습니다.
