---
title: 'Edge 구독 역할: Exchange 2013 Help'
TOCTitle: Edge 구독 역할
ms:assetid: 7de1a663-96fb-4fb5-898a-effa82653597
ms:mtpsurl: https://technet.microsoft.com/ko-kr/library/Dd876912(v=EXCHG.150)
ms:contentKeyID: 50483504
ms.date: 05/22/2018
...
관리자는 `Edge Subscriptions` 관리 역할을 사용하여 조직에서 Microsoft Exchange Server 2010 Edge 전송 서버와 Microsoft Exchange Server 2013 사서함 서버 간 Edge 동기화 및 구독 구성을 관리할 수 있습니다.
