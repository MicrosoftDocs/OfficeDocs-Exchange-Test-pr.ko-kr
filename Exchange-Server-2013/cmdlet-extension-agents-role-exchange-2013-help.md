---
title: 'Cmdlet 확장 에이전트 역할: Exchange 2013 Help'
TOCTitle: Cmdlet 확장 에이전트 역할
ms:assetid: 20f9f7c2-a8e5-468e-b1a8-c87c562a2be7
ms:mtpsurl: https://technet.microsoft.com/ko-kr/library/Dd876857(v=EXCHG.150)
ms:contentKeyID: 50482710
ms.date: 05/22/2018
