---
title: '조직 전송 설정 역할: Exchange 2013 Help'
TOCTitle: 조직 전송 설정 역할
ms:assetid: ff4d032e-1b97-4a9d-b479-9b0d61832221
ms:mtpsurl: https://technet.microsoft.com/ko-kr/library/Dd876961(v=EXCHG.150)
ms:contentKeyID: 50484614
ms.date: 05/22/2018
...
이 역할 만들거나 보내기 또는 받기 커넥터, 큐, 방역, 에이전트, 원격 및 허용 도메인 또는 규칙을 관리 하도록 활성화 되지 않습니다. 을 만들거나 각 전송 기능을 관리 하려면 할당 되어 있어야 다음 역할 중 하나 이상:
