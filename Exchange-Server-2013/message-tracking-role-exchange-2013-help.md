---
title: '메시지 추적 역할: Exchange 2013 Help'
TOCTitle: 메시지 추적 역할
ms:assetid: 21f18ccd-9b7d-461b-b77c-443d15696d79
ms:mtpsurl: https://technet.microsoft.com/ko-kr/library/Dd876858(v=EXCHG.150)
ms:contentKeyID: 50482653
ms.date: 05/22/2018
...
`Message Tracking` 관리 역할을 사용하면 관리자가 조직의 메시지를 추적할 수 있습니다.
