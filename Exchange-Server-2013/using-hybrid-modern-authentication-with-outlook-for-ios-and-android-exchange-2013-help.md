---
title: 'IOS에 대 한 Outlook 및 Android 하이브리드 현대 인증을 사용 하 여: Exchange 2013 Help'
TOCTitle: IOS에 대 한 Outlook 및 Android 하이브리드 현대 인증을 사용 하 여
ms:assetid: 0e701643-1f18-4cc3-8595-4fd4b15caf6c
ms:mtpsurl: https://technet.microsoft.com/ko-kr/library/Mt846639(v=EXCHG.150)
ms:contentKeyID: 74520302
ms.date: 04/24/2018
mtps_version: v=EXCHG.150
ms.translationtype: HT
---

# IOS에 대 한 Outlook 및 Android 하이브리드 현대 인증을 사용 하 여

 

_**적용 대상:** Exchange Server 2013_

_**마지막으로 수정된 항목:** 2018-04-19_
...
![iOS 및 Android용 Outlook의 하이브리드 최신 인증의 아키텍처 다이어그램](images/Mt846639.20a7e963-916d-47e0-bffb-4d86c4777bea(EXCHG.150).png "iOS 및 Android용 Outlook의 하이브리드 최신 인증의 아키텍처 다이어그램")
...
![하이브리드 최신 인증의 인증 흐름](images/Mt846639.d6e20ddb-cf8e-4154-8a17-95657ef696d1(EXCHG.150).png "하이브리드 최신 인증의 인증 흐름")
...
![하이브리드 최신 인증용으로 구성된 iOS 및 Android용 Outlook 예제](images/Mt846639.79887a65-e5e1-4501-a274-008393dbb6c9(EXCHG.150).png "하이브리드 최신 인증용으로 구성된 iOS 및 Android용 Outlook 예제")
