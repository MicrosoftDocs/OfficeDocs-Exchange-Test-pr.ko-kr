---
title: 'ArchiveApplication 역할: Exchange 2013 Help'
TOCTitle: ArchiveApplication 역할
ms:assetid: 22d673cf-d3a3-43f0-be1e-e4fc74546e64
ms:mtpsurl: https://technet.microsoft.com/ko-kr/library/JJ673046(v=EXCHG.150)
ms:contentKeyID: 50482728
ms.date: 05/22/2018
...
`ArchiveApplication` 관리 역할을 사용하면 파트너 응용 프로그램이 항목을 사용자 사서함에 보관할 수 있습니다.
