---
title: '재해 복구 역할: Exchange 2013 Help'
TOCTitle: 재해 복구 역할
ms:assetid: 6dd321a8-7621-44be-b3c5-76535e006653
ms:mtpsurl: https://technet.microsoft.com/ko-kr/library/Dd876902(v=EXCHG.150)
ms:contentKeyID: 50483399
ms.date: 05/22/2018
...
관리자는 `Disaster Recovery` 관리 역할을 사용하여 사서함 및 사서함 데이터베이스를 복원하고, 사서함 데이터베이스를 만들고, 조직에서 데이터베이스 가용성 그룹에 대한 데이터 센터 전환 및 다시 전환을 수행할 수 있습니다.
