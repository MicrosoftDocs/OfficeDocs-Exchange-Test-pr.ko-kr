---
title: '범위가 지정 되지 않은 역할 관리 역할: Exchange 2013 Help'
TOCTitle: 범위가 지정 되지 않은 역할 관리 역할
ms:assetid: d11eb843-64c9-4968-bfd5-9a8d94903058
ms:mtpsurl: https://technet.microsoft.com/ko-kr/library/Dd876943(v=EXCHG.150)
ms:contentKeyID: 50484211
ms.date: 05/22/2018
...
`Unscoped Role Management` 관리 역할을 통해 관리자가 조직에서 범위가 지정되지 않은 최상위 관리 역할을 만들고 관리할 수 있습니다.
