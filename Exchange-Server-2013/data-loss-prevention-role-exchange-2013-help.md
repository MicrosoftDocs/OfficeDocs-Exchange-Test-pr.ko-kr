---
title: '데이터 손실 방지 역할: Exchange 2013 Help'
TOCTitle: 데이터 손실 방지 역할
ms:assetid: 026d0e48-f4da-416e-a00d-794bd3b38c5c
ms:mtpsurl: https://technet.microsoft.com/ko-kr/library/JJ673034(v=EXCHG.150)
ms:contentKeyID: 50482390
ms.date: 05/22/2018
...
데이터 손실 방지 관리 역할을 사용하면 관리자가 전체 조직의 메일 배달에 영향을 미칠 수 있는 DLP(데이터 손실 방지) 정책과 해당 정책 내의 규칙을 만들고 관리할 수 있습니다. 또한 이 역할을 통해 관리자는 전자 메일 클라이언트에 나타나는 정책 팁을 구성하고 DLP 정책 위반 보고서를 관리할 수 있습니다. 이 DLP 역할을 통해 Microsoft Exchange 전송 규칙에 액세스할 수도 있습니다. Exchange의 전송 규칙에 대한 자세한 내용은 다음 항목을 참조하십시오.

  - [전송 규칙 역할](transport-rules-role-exchange-2013-help.md)

  - [전송 규칙에 대 한 새로운 기능](what-s-new-for-transport-rules-exchange-2013-help.md)
