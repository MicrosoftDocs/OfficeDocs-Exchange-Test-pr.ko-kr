---
title: 'MyContactInformation 역할: Exchange 2013 Help'
TOCTitle: MyContactInformation 역할
ms:assetid: 0df7fc20-d9b3-40db-bb14-ba8b903df201
ms:mtpsurl: https://technet.microsoft.com/ko-kr/library/Dd876850(v=EXCHG.150)
ms:contentKeyID: 50482502
ms.date: 05/22/2018
...
`MyContactInformation` 관리 역할을 사용하면 개별 사용자가 주소와 전화 번호를 비롯한 연락처 정보를 수정할 수 있습니다.
