...
2.  **새 동적 메일 그룹** 페이지에서 다음 상자에 정보를 입력합니다.
...
3.  **구성원** 섹션을 사용하여 그룹의 받는 사람 유형을 지정하고 구성원 자격을 결정할 규칙을 설정합니다. 다음 확인란 중 하나를 선택합니다.
...
4.  **규칙 추가**를 클릭하여 이 그룹의 구성원 자격에 대한 기준을 정의합니다.
