---
title: 'ApplicationImpersonation 역할: Exchange 2013 Help'
TOCTitle: ApplicationImpersonation 역할
ms:assetid: d6e43a2f-9b1f-463e-8c56-ca38d9127a5a
ms:mtpsurl: https://technet.microsoft.com/ko-kr/library/Dd776119(v=EXCHG.150)
ms:contentKeyID: 50484311
ms.date: 05/22/2018
...
> [!IMPORTANT]
> <CODE>ApplicationImpersonation</CODE> 역할의 구성원인 프로세스 또는 응용 프로그램은 사용자 계정이 사용하지 않도록 설정되어 있어도 사용자 사서함의 내용에 액세스하고 해당 사용자를 대신하여 작업을 수행할 수 있습니다. 따라서 <CODE>ApplicationImpersonation</CODE> 역할을 사용하는 Blackberry Enterprise Server 등의 응용 프로그램이 있으면 사용자가 자신의 사서함에 액세스할 수 있습니다. <CODE>ApplicationImpersonation</CODE> 역할 대신 Exchange ActiveSync를 사용하는 타사 제품은 사용자 계정이 사용하지 않도록 설정되고 나면 사서함에 액세스할 수 없습니다.<BR>사용자 계정이 사용하지 않도록 설정된 후 <CODE>ApplicationImpersonation</CODE> 역할을 사용하는 응용 프로그램이 사서함에 액세스하거나 사용자 대신 작업을 수행할 수 없도록 하려면 다음 중 하나 이상을 수행합니다. 
> <UL>
> <LI>
> <P>타사 응용 프로그램에서 사용자를 제거하거나 사용하지 않도록 설정합니다.</P>
> <LI>
> <P>사서함을 삭제합니다.</P></LI></UL>
