---
title: 'Mailbox Import Export 역할: Exchange 2013 Help'
TOCTitle: Mailbox Import Export 역할
ms:assetid: d7cdce7a-6c46-4750-b237-d1c1773e8d28
ms:mtpsurl: https://technet.microsoft.com/ko-kr/library/Ee633482(v=EXCHG.150)
ms:contentKeyID: 50484249
ms.date: 05/22/2018
...
`Mailbox Import Export` 관리 역할을 통해 관리자가 사서함 콘텐츠를 가져오고 내보내고 필요 없는 콘텐츠를 사서함에서 제거할 수 있습니다.
