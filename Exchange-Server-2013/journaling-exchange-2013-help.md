...
사서함 데이터베이스에 대해 표준 저널링을 사용하도록 설정하면 이 정보가 Active Directory에 저장되며 저널링 에이전트에서 이 정보를 읽습니다. 마찬가지로 고급 저널링으로 구성된 저널 규칙도 Active Directory에 저장되며 저널링 에이전트에 의해 적용됩니다. 표준 및 고급 저널링 구성 방법에 대한 자세한 내용은 [저널링 관리](manage-journaling-exchange-2013-help.md)를 참조하십시오.
