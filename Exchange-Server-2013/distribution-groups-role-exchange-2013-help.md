---
title: '메일 그룹 역할: Exchange 2013 Help'
TOCTitle: 메일 그룹 역할
ms:assetid: 0c3667b6-529b-4bb2-85bf-e24fae82d082
ms:mtpsurl: https://technet.microsoft.com/ko-kr/library/Dd876848(v=EXCHG.150)
ms:contentKeyID: 50482453
ms.date: 05/22/2018
...
`Distribution Groups` 관리 역할을 사용하면 관리자가 메일 그룹을 만들고 수정하고 보고 제거할 수 있으며 조직의 메일 그룹 구성원을 추가하거나 제거할 수 있습니다.
