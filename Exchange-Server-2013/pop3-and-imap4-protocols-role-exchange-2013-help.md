---
title: 'POP3 및 IMAP4 프로토콜 역할: Exchange 2013 Help'
TOCTitle: POP3 및 IMAP4 프로토콜 역할
ms:assetid: 67dd66e0-3cca-4f87-8165-4918519b39b6
ms:mtpsurl: https://technet.microsoft.com/ko-kr/library/Dd876898(v=EXCHG.150)
ms:contentKeyID: 50483292
ms.date: 05/22/2018
mtps_version: v=EXCHG.150
ms.translationtype: MT
---

# POP3 및 IMAP4 프로토콜 역할
...
관리자는 `POP3 and IMAP4 Protocols` 관리 역할을 사용하여 개별 서버에서 인증 및 연결 설정과 같은 POP3 및 IMAP4 구성을 관리할 수 있습니다.
