---
title: '마이그레이션 역할: Exchange 2013 Help'
TOCTitle: 마이그레이션 역할
ms:assetid: 8b5a3385-7dc0-4492-9f00-a4616982016b
ms:mtpsurl: https://technet.microsoft.com/ko-kr/library/Dd876920(v=EXCHG.150)
ms:contentKeyID: 50483623
ms.date: 05/22/2018
...
관리자는 `Migration` 관리 역할을 사용하여 서버에서 사서함 및 사서함 내용을 양방향으로 마이그레이션할 수 있습니다.
