---
title: '전송 규칙 역할: Exchange 2013 Help'
TOCTitle: 전송 규칙 역할
ms:assetid: 53c5b1a5-e989-4373-ac70-7db16000c645
ms:mtpsurl: https://technet.microsoft.com/ko-kr/library/Dd876885(v=EXCHG.150)
ms:contentKeyID: 50483122
ms.date: 05/22/2018
...
관리자는 `Transport Rules` 관리 역할을 사용하여 조직에서 전송 규칙을 관리할 수 있습니다.
