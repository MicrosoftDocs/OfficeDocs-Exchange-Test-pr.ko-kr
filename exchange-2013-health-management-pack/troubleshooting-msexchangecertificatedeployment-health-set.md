---
title: " 설정 MSExchangeCertificateDeployment 상태 문제를 해결"
TOCTitle: " 설정 MSExchangeCertificateDeployment 상태 문제를 해결"
ms:assetid: 27410f8f-25bd-4bde-b4d5-5597c15d9ec7
ms:mtpsurl: https://technet.microsoft.com/ko-kr/library/ms.exch.scom.msexchangecertificatedeployment(v=EXCHG.150)
ms:contentKeyID: 54651863
ms.date: 12/15/2016
mtps_version: v=EXCHG.150
ms.translationtype: HT
---

# 설정 MSExchangeCertificateDeployment 상태 문제를 해결
