---
title: " 설정 MailboxMigration 상태 문제를 해결"
TOCTitle: " 설정 MailboxMigration 상태 문제를 해결"
ms:assetid: 4219fe4b-6757-409a-9065-d81d07d144b2
ms:mtpsurl: https://technet.microsoft.com/ko-kr/library/ms.exch.scom.mailboxmigration(v=EXCHG.150)
ms:contentKeyID: 54651869
ms.date: 12/15/2016
mtps_version: v=EXCHG.150
ms.translationtype: HT
---

# 설정 MailboxMigration 상태 문제를 해결
