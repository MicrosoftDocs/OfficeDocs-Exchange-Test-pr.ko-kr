---
title: PushNotifications.Protocol 상태 설정 문제해결
TOCTitle: PushNotifications.Protocol 상태 설정 문제해결
ms:assetid: ef8dfb26-cfe4-4bcc-b18a-5f15f1f8c99e
ms:mtpsurl: https://technet.microsoft.com/ko-kr/library/ms.exch.scom.pushnotifications.protocol(v=EXCHG.150)
ms:contentKeyID: 54651895
ms.date: 12/15/2016
mtps_version: v=EXCHG.150
ms.translationtype: HT
---

# PushNotifications.Protocol 상태 설정 문제해결
