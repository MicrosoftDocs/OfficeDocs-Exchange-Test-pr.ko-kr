---
title: " 설정 PowershellDataProvider 상태 문제를 해결"
TOCTitle: " 설정 PowershellDataProvider 상태 문제를 해결"
ms:assetid: 2f083d29-b3be-4955-95f6-cd7e4931bc61
ms:mtpsurl: https://technet.microsoft.com/ko-kr/library/ms.exch.scom.powershelldataprovider(v=EXCHG.150)
ms:contentKeyID: 54651866
ms.date: 12/15/2016
mtps_version: v=EXCHG.150
ms.translationtype: HT
---

# 설정 PowershellDataProvider 상태 문제를 해결
